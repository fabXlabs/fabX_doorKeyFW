...
class Sercom4SPISlave {
 public:
  ...
  // Types //
  enum MOSI_Pins {PA12, PB08, PB12, PB10};
  enum SCK_Pins {PA13, PB09, PB13, PB11};
  enum SS_Pins {PA14, PB10, PB14, PA13};
  enum MISO_Pins {PA15, PB11, PB15, PA12};
   ...
   * 
   * @param[in] MOSI_Pin PA12, PB08, PB12, PB10
   * @param[in] SCK_Pin PA13, PB09, PB13, PB11
   * @param[in] SS_Pin PA14, PB10, PB14, PA13
   * @param[in] MISO_Pin PA15, PB11, PB15, PA12
   * 
   */
  void SercomInit(MOSI_Pins MOSI_Pin, SCK_Pins SCK_Pin, SS_Pins SS_Pin, MISO_Pins MISO_Pin);
};
